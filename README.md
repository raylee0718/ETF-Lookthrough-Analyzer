...
0050 元大台灣50 是第一個台灣 ETF provider prototype。App 會嘗試讀取元大投信官方 0050 持股比重頁：`https://www.yuantaetfs.com/product/detail/0050/ratio`。

發行商網站可能有 CORS、動態頁面或只在頁面摘要揭露部分資料，因此瀏覽器 fetch 不一定能穩定取得完整成分股。若 0050 自動來源失敗或只取得部分持股，CSV 匯入仍是備援流程。海外 ETF，例如 00646，尚未支援。
